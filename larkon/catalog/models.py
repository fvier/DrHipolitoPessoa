...
class HomePageConfig(models.Model):
    ...
    og_share_title = models.CharField(_("Título no Compartilhamento"), max_length=200, blank=True, default="Dr. Hipólito Pessoa • CRM RN 7742")
    og_share_description = models.TextField(_("Descrição no Compartilhamento"), blank=True, default="Pós-Graduação em Psiquiatria & Geriatria. Atendimento médico humanizado, saúde mental e atenção à pessoa idosa no Alto Oeste Potiguar.")
